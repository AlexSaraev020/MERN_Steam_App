            ...
            {gamesData && gamesData.length > 0 &&
                        <section className={`relative flex flex-col items-center justify-center w-full mt-10 md:mb-10`}>
                            ...
                            <div className={`flex relative items-center justify-center w-full md:space-x-4`}>
                                <div ref={scrollRef} className={`w-11/12 md:w-10/12 lg:w-10/12 xl:w-11/12 items-center flex lg:scrollbar-thin scrollbar-thumb-${theme}-500 scrollbar-track-zinc-800 overflow-x-scroll space-x-4 pt-20 pb-6 px-9`}>
