    ...
    return (
        <section className={`relative flex justify-center items-center`}>
            <div className={`w-full flex flex-col items-center justify-center mt-10 lg:mt-0`}>
                ...
                <Carousel
                    leftControl={
                        <div className={`rounded-full h-10 w-10 sm:w-14 sm:h-14 flex bg-${theme}-500 shadow-glow shadow-${theme}-500 items-center justify-center hover:scale-110 transition-all duration-500`}>
