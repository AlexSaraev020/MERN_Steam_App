...
const navLinks: NavLinkType[] = [
    { to: '/', icon: <HomeSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Home' },
    { to: '/', icon: <StoreSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Catalogue' },
    { to: '/', icon: <ProfileSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Profile' },
    { to: '/', icon: <FavouritesSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Favorite' },
    { to: '/', icon: <LogOutSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Log Out' }
]
