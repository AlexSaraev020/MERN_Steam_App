...
const NavigationMenu: React.FC = () => {
    ...
    const navLinks: NavLinkType[] = [
        { to: '/home', icon: <HomeSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Home' },
        { to: '/catalogue', icon: <StoreSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Catalogue' },
        { to: '/profile', icon: <ProfileSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Profile' },
        { to: '/favorites', icon: <FavouritesSVG className="w-6 h-6 -mb-1 lg:h-6 lg:w-6 mr-1 sm:mr-2" />, label: 'Favorite' },
