...
const FavoriteButton: React.FC<FavoriteButtonProps> = ({ gameId }) => {
    ...
    return (
        ...
        <button className={`text-white flex items-center justify-center w-44 hover:text-${theme}-500 hover:scale-105 transition-all bg-gradient-to-tr from-zinc-900 via-zinc-800 to-zinc-900 border-2 border-zinc-700 hover:shadow-${theme}-500 font-medium rounded-lg text-lg xl:text-xl px-5 py-2 focus:outline-none duration-500 ${
            favoriteButton ? `shadow-glow shadow-${theme}-500` : 'shadow-md shadow-zinc-800'
