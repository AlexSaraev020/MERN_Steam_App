                ...
                <ul className={`w-11/12 sm:w-9/12 space-y-20 sm:space-y-8 bg-[#1e1e1e] rounded-xl flex flex-col justify-center items-center border-2 border-zinc-800 transition ease-in-out duration pb-10`}>
                    ...
                    {favoriteGames.length > 10 && <div className={`w-10/12 sm:w-11/12 flex py-4 space-x-6 justify-center`}>
                        ...
                        <div className={`flex justify-center space-x-3 text-lg font-semibold font-mono`}>
                            {activePrevPage && <h2 className={`text-${theme}-500 flex items-center justify-center px-6 border-2 rounded-lg border-${theme}-700 bg-gradient-to-tr from-zinc-900 via-zinc-800 to-zinc-900 shadow-md shadow-zinc-600 transition-all duration-500 ease-in-out animate-fadeIn`}>{page}</h2>}
                            <h2 className={`text-${theme}-500 flex items-center justify-center px-6 border-2 rounded-lg border-${theme}-700 bg-gradient-to-tr from-zinc-900 via-zinc-800 to-zinc-900 shadow-glow shadow-${theme}-500 scale-105 -translate-y-1 transition-all duration-500 ease-in-out animate-fadeIn`}>{page + 1}</h2>
                            {activeNextPage && <h2 className={`text-${theme}-500 flex items-center justify-center px-6 border-2 rounded-lg border-${theme}-700 bg-gradient-to-tr from-zinc-900 via-zinc-800 to-zinc-900 shadow-md shadow-zinc-600 transition-all duration-500 ease-in-out animate-fadeIn`}>{page + 2}</h2>}
                        </div>
