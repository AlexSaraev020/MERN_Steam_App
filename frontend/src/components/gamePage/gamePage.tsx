    ...
    return (
        <div className="flex flex-col bg-gray-300 min-h-screen relative text-white">
            ...
            <div className="w-full flex items-center justify-center z-10 min-h-screen">
                <div className="rounded-t-lg w-11/12 md:w-5/6 flex flex-col min-h-screen bg-slate-800 p-8">
                    <div className="flex flex-col xl:flex-row w-full">
                        ...
                        <div className="w-full xl:w-5/12 xl:pl-4 flex flex-col justify-between">
                            <div>
                                ...
                                <h2 className="text-sm xl:text-xl">Genre : <span className="text-blue-400 font-bold">{gamesDetails?.genre}</span></h2>
                                <p className="text-sm xl:text-lg text-gray-400">{gamesDetails?.short_description}</p>
                                <h2 className="text-sm xl:text-lg">Developer : <span className="text-blue-400 font-bold text-md xl:text-xl">{gamesDetails?.developer}</span></h2>
                                <h2 className="text-sm xl:text-lg">Publisher : <span className="text-blue-400 font-bold text-md xl:text-xl">{gamesDetails?.publisher}</span></h2>
                            ...
                            <button className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg mt-2 xl:mt-0 text-lg xl:text-xl px-5 py-2 focus:outline-none xl:w-48 xl:h-14">
