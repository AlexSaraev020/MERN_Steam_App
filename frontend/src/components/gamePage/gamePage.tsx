                    ...
                    <div className="flex flex-col xl:flex-row w-full">
                        ...
                        <div className="w-full xl:w-5/12 xl:pl-8 flex flex-col justify-between font-mono ">
                            <div className="space-y-4 ">
                                ...
                                <h3 className="text-sm xl:text-lg">Developer: <span className="text-emerald-500 font-bold text-md xl:text-xl">{game?.developer}</span></h3>
                                <h3 className="text-sm xl:text-lg">Publisher: <span className="text-emerald-500 font-bold text-md xl:text-xl">{game?.publisher}</span></h3>
                            ...
                            <div className="flex flex-col xl:flex-row items-start xl:items-center mt-4 space-y-2 xl:space-y-0 xl:space-x-4">
                                <button onClick={getTheGameButton} className="text-white flex items-center justify-center w-44 hover:text-emerald-500 hover:scale-105 transition-all  bg-gradient-to-tr from-zinc-900 via-zinc-800 to-zinc-900 shadow-md shadow-zinc-800 border-2 border-zinc-700 hover:shadow-emerald-500 focus:ring-4 focus:ring-emerald-600 font-medium rounded-lg text-lg xl:text-xl px-5 py-3 focus:outline-none duration-500">
